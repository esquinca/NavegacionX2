              ...
              <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                  <div class="form-inline">
                    ...
                    <!-- <div class="form-group">
                      <div class="col-xs-12">
                        <button type="button" class="btn btn-success btnconsumptiondown"><i class="fa fa-user-plus margin-r5"></i> Crear Usuario</button>
                        <button type="button" class="btn btn-info btnconsumptiondown"><i class="fa fa-pencil-square-o margin-r5"></i> Editar</button>
                        <button type="button" class="btn btn-danger btnconsumptiondown"><i class="fa fa-user-times margin-r5"></i> Eliminar</button>
                      </div>
                    </div> -->
                  </div>
                </div>
